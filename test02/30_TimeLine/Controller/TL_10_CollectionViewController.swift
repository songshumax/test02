...
class TL_10_CollectionViewController: UIViewController {
...
//        collectionview.register(TL_Common_CollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
        ...
        collectionview = UIScrollView(frame:self.view.bounds)
...
//        self.view.addSubview(scrollView)
    ...
    func setupView() {
        ...
        collectionview.addSubview(contentLayout)
    ...
    {
        let porfilename = UILabel()
        let porfiledetailes = UILabel()
