//
//  XXX_102010_AddMap.swift
//  test02
//
//  Created by fangli on 2018/8/16.
...
class XXX_102010_AddMap: UIViewController {
    ...
    lazy var panGesture: UIPanGestureRecognizer = {
        let instance = UIPanGestureRecognizer(target: self, action: #selector(XXX_102010_AddMap.handlePan))
        return instance
    }()
